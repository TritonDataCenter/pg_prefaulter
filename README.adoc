...
* image::images/lag_recovery_thumb.png["Apply Lag recovery",height=200,link="images/lag_recovery.png"]
* image::images/lag_steady_state_thumb.png["Apply Lag steady-state",height=200,link="images/lag_steady_state.png"]
